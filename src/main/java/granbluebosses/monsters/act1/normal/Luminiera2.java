...
import granbluebosses.cards.LuminieraOmega;
...
//        addToBot(new ApplyPowerAction(this, this, new BlurPower(this, 1)));
    ...
    public void die() {
        if (ConfigMenu.enableExtraRewards) {
            ...
            reward.cards.add(new LuminieraOmega());
        ...
        BaseMod.addEvent(LuminieraEvent.EVENT_ID, LuminieraEvent.class, Act1Skies.ID);
