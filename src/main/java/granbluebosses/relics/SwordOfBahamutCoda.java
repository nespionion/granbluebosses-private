...
public class SwordOfBahamutCoda extends BaseRelic {

    public static final String RELIC_ID = GranblueBosses.makeID("SwordOfBahamutCoda");

    public SwordOfBahamutCoda() {
        super(
                RELIC_ID,                                                     // ID
                "SwordOfBahamutCoda",
    ...
    public void onEquip() {
        ...
        AbstractDungeon.player.loseRelic(SwordOfBahamut.RELIC_ID);
    }
